...
public class BoardController {
	...
	public BoardDto getArticle(int articleNo) throws Exception {
		System.out.println("BoardController getArticle method call!!!!!");
		return boardService.getArticle(articleNo);
	}

	public void updateHit(int articleNo) throws Exception {
		System.out.println("BoardController updateHit method call!!!!!");
		boardService.updateHit(articleNo);
	}

	public void modifyArticle(BoardDto boardDto) throws Exception {
		System.out.println("BoardController modifyArticle method call!!!!!");
		boardService.modifyArticle(boardDto);
	}

	public void deleteArticle(int articleNo) throws Exception {
		System.out.println("BoardController deleteArticle method call!!!!!");
